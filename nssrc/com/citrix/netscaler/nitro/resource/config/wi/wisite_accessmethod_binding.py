...
class wisite_accessmethod_binding(base_resource) :
	...
	def clientipaddress(self) :
		"""IPv4 or network address of the client for which you want to associate an access method.<br/>Default value: 0.
		"""
		try :
	...
	def clientnetmask(self) :
		"""Subnet mask associated with the IPv4 or network address specified by the Client IP Address parameter.<br/>Default value: 0.
		"""
		try :
	...
	def get(cls, service, sitepath) :
		""" Use this API to fetch wisite_accessmethod_binding resources.
		"""
		try :
