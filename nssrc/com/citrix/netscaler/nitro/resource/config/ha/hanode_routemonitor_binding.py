...
class hanode_routemonitor_binding(base_resource) :
	...
	def get(cls, service, id) :
		""" Use this API to fetch hanode_routemonitor_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, id, filter_) :
		""" Use this API to fetch filtered set of hanode_routemonitor_binding resources.
	...
	def count(cls, service, id) :
		""" Use this API to count hanode_routemonitor_binding resources configued on NetScaler.
		"""
		try :
			obj = hanode_routemonitor_binding()
			obj.id = id
