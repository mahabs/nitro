...
class hanode(base_resource) :
	...
	@property
	def id(self) :
		"""Number that uniquely identifies the node. For self node, it will always be 0. Peer node values can range from 1-64.<br/>Minimum length =  1<br/>Maximum length =  64.
		"""
		try :
			return self._id
	...
	def hellointerval(self) :
		"""Interval, in milliseconds, between heartbeat messages sent to the peer node. The heartbeat messages are UDP packets sent to port 3003 of the peer node.<br/>Default value: 200<br/>Minimum length =  200<br/>Maximum length =  1000.
		"""
		try :
	...
	def deadinterval(self) :
		"""Number of seconds after which a peer node is marked DOWN if heartbeat messages are not received from the peer node.<br/>Default value: 3<br/>Minimum length =  3<br/>Maximum length =  60.
		"""
		try :
	...
	@property
	def maxflips(self) :
		"""Max number of flips allowed before becoming sticky primary.<br/>Default value: 0.
		"""
		try :
	...
	def maxfliptime(self) :
		"""Interval after which flipping of node states can again start.<br/>Default value: 0.
		"""
		try :
	...
	@property
	def syncvlan(self) :
		"""Vlan on which HA related communication is sent. This include sync, propagation , connection mirroring , LB persistency config sync, persistent session sync and session state sync. However HA heartbeats can go all interfaces.<br/>Minimum length =  1<br/>Maximum length =  4094.
		"""
		try :
	...
	def routemonitorstate(self) :
		"""State for route monitor.<br/>Possible values = UP, DOWN.
		"""
		try :
