...
class ntpserver(base_resource) :
	...
	@property
	def minpoll(self) :
		"""Minimum time after which the NTP server must poll the NTP messages. In seconds, expressed as a power of 2.<br/>Minimum length =  4<br/>Maximum length =  17.
		"""
		try :
	...
	@property
	def maxpoll(self) :
		"""Maximum time after which the NTP server must poll the NTP messages. In seconds, expressed as a power of 2.<br/>Minimum length =  4<br/>Maximum length =  17.
		"""
		try :
