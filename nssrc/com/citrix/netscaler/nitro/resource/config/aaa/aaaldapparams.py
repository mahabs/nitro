...
class aaaldapparams(base_resource) :
	...
	@property
	def serverport(self) :
		"""Port number on which the LDAP server listens for connections.<br/>Default value: 389<br/>Minimum length =  1.
		"""
		try :
	...
	def authtimeout(self) :
		"""Maximum number of seconds that the NetScaler appliance waits for a response from the LDAP server.<br/>Default value: 3<br/>Minimum length =  1.
		"""
		try :
	...
	def maxnestinglevel(self) :
		"""Number of levels up to which the system can query nested LDAP groups.<br/>Default value: 2<br/>Minimum length =  2.
		"""
		try :
