...
class aaauser_auditnslogpolicy_binding(base_resource) :
	...
	def get(cls, service, username) :
		""" Use this API to fetch aaauser_auditnslogpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, username, filter_) :
		""" Use this API to fetch filtered set of aaauser_auditnslogpolicy_binding resources.
	...
	def count(cls, service, username) :
		""" Use this API to count aaauser_auditnslogpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = aaauser_auditnslogpolicy_binding()
			obj.username = username
	...
	def count_filtered(cls, service, username, filter_) :
		""" Use this API to count the filtered set of aaauser_auditnslogpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = aaauser_auditnslogpolicy_binding()
