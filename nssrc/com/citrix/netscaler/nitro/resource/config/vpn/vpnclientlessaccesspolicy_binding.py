...
class vpnclientlessaccesspolicy_binding(base_resource):
	...
	def vpnclientlessaccesspolicy_vpnglobal_bindings(self) :
		"""vpnglobal that can be bound to vpnclientlessaccesspolicy.
		"""
		try :
	...
	def vpnclientlessaccesspolicy_vpnvserver_bindings(self) :
		"""vpnvserver that can be bound to vpnclientlessaccesspolicy.
		"""
		try :
	...
	def get(self, service, name) :
		""" Use this API to fetch vpnclientlessaccesspolicy_binding resource.
		"""
		try :
