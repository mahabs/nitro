...
class vpnglobal_authenticationtacacspolicy_binding(base_resource) :
	...
	def get_filtered(cls, service, filter_) :
		""" Use this API to fetch filtered set of vpnglobal_authenticationtacacspolicy_binding resources.
	...
	def count(cls, service) :
		""" Use this API to count vpnglobal_authenticationtacacspolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = vpnglobal_authenticationtacacspolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		""" Use this API to count the filtered set of vpnglobal_authenticationtacacspolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vpnglobal_authenticationtacacspolicy_binding()
