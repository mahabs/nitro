...
class vpnnexthopserver(base_resource) :
	...
	@property
	def name(self) :
		"""Name for the NetScaler Gateway appliance in the first DMZ.<br/>Minimum length =  1<br/>Maximum length =  32.
		"""
		try :
			return self._name
	...
	def nexthopport(self) :
		"""Port number of the NetScaler Gateway proxy in the second DMZ.<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
