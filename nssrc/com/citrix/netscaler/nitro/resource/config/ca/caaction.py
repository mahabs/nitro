...
class caaction(base_resource) :
	...
	@property
	def type(self) :
		"""Specifies whether the NetScaler must lookup for the response on the T2100 appliance or serve the response directly from the server.<br/>Possible values = nolookup, lookup, noop.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@property
	def builtin(self) :
		"""Flag to determine whether content accelerator action is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
	...
	def update(cls, client, resource) :
		""" Use this API to update caaction.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		""" Use this API to unset the properties of caaction resource.
	...
	def delete(cls, client, resource) :
		""" Use this API to delete caaction.
		"""
		try :
			if type(resource) is not list :
	...
	def rename(cls, client, resource, new_name) :
		""" Use this API to rename a caaction resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		""" Use this API to fetch all the caaction resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = caaction()
	...
	def get_filtered(cls, client, filter_) :
		""" Use this API to fetch filtered set of caaction resources.
	...
	def count(cls, client) :
		""" Use this API to count the caaction resources configured on NetScaler.
		"""
		try :
			obj = caaction()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		""" Use this API to count filtered the set of caaction resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = caaction()
