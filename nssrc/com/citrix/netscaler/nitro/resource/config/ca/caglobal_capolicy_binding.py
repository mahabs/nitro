...
class caglobal_capolicy_binding(base_resource) :
	...
	@property
	def type(self) :
		""".<br/>Possible values = REQ_OVERRIDE, REQ_DEFAULT, RES_OVERRIDE, RES_DEFAULT.
		"""
		try :
			return self._type
		except Exception as e:
	...
	@classmethod
	def get(cls, service) :
		""" Use this API to fetch a caglobal_capolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		""" Use this API to fetch filtered set of caglobal_capolicy_binding resources.
	...
	def count(cls, service) :
		""" Use this API to count caglobal_capolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = caglobal_capolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		""" Use this API to count the filtered set of caglobal_capolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = caglobal_capolicy_binding()
