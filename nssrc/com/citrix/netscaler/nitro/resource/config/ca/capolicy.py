...
class capolicy(base_resource) :
	...
	@property
	def newname(self) :
		"""New name for the content accelerator policy.<br/>Minimum length =  1.
		"""
		try :
	...
	def rename(cls, client, resource, new_name) :
		""" Use this API to rename a capolicy resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		""" Use this API to fetch all the capolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = capolicy()
	...
	def get_filtered(cls, client, filter_) :
		""" Use this API to fetch filtered set of capolicy resources.
	...
	def count(cls, client) :
		""" Use this API to count the capolicy resources configured on NetScaler.
		"""
		try :
			obj = capolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		""" Use this API to count filtered the set of capolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = capolicy()
