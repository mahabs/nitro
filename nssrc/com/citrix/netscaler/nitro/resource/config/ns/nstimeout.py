...
class nstimeout(base_resource) :
	...
	@property
	def client(self) :
		"""Client idle timeout (in seconds).  If zero, the service-type default value is taken when service is created.<br/>Maximum length =  18000.
		"""
		try :
			return self._client
		except Exception as e:
	...
	@property
	def server(self) :
		"""Server idle timeout (in seconds).  If zero, the service-type default is taken when service is created.<br/>Maximum length =  18000.
		"""
		try :
			return self._server
		except Exception as e:
	...
	@property
	def httpclient(self) :
		"""Global idle timeout, in seconds, for client connections of HTTP service type. This value is over ridden by the client timeout that is configured on individual entities.<br/>Maximum length =  18000.
		"""
		try :
	...
	@property
	def httpserver(self) :
		"""Global idle timeout, in seconds, for server connections of HTTP service type. This value is over ridden by the server timeout that is configured on individual entities.<br/>Maximum length =  18000.
		"""
		try :
	...
	@property
	def tcpclient(self) :
		"""Global idle timeout, in seconds, for non-HTTP client connections of TCP service type. This value is over ridden by the client timeout that is configured on individual entities.<br/>Maximum length =  18000.
		"""
		try :
	...
	@property
	def tcpserver(self) :
		"""Global idle timeout, in seconds, for non-HTTP server connections of TCP service type. This value is over ridden by the server timeout that is configured on entities.<br/>Maximum length =  18000.
		"""
		try :
	...
	@property
	def anyclient(self) :
		"""Global idle timeout, in seconds, for non-TCP client connections. This value is over ridden by the client timeout that is configured on individual entities.<br/>Maximum length =  31536000.
		"""
		try :
	...
	@property
	def anyserver(self) :
		"""Global idle timeout, in seconds, for non TCP server connections. This value is over ridden by the server timeout that is configured on individual entities.<br/>Maximum length =  31536000.
		"""
		try :
	...
	def reducedfintimeout(self) :
		"""Alternative idle timeout for new TCP NATPCB connections.<br/>Default value: 30<br/>Minimum length =  1<br/>Maximum length =  300.
		"""
		try :
	...
	def reducedrsttimeout(self) :
		"""Timer interval(in seconds) for NATPCB for tcp flow.<br/>Default value: 30<br/>Minimum length =  1<br/>Maximum length =  300.
		"""
		try :
	...
	def newconnidletimeout(self) :
		"""Timer interval(in seconds) for new NATPCB for tcp connections.<br/>Default value: 4<br/>Minimum length =  1<br/>Maximum length =  120.
		"""
		try :
