...
class nshostname(base_resource) :
	...
	@property
	def ownernode(self) :
		"""ID of the cluster node for which you are setting the hostname. Can be configured only through the cluster IP address.<br/>Default value: 255<br/>Maximum length =  31.
		"""
		try :
