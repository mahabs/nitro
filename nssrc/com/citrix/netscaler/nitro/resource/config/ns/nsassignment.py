...
class nsassignment(base_resource) :
	...
	def add(cls, client, resource) :
		""" Use this API to add nsassignment.
		"""
		try :
	...
	def delete(cls, client, resource) :
		""" Use this API to delete nsassignment.
		"""
		try :
			if type(resource) is not list :
	...
	def rename(cls, client, resource, new_name) :
		""" Use this API to rename a nsassignment resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		""" Use this API to fetch all the nsassignment resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = nsassignment()
	...
	def get_filtered(cls, client, filter_) :
		""" Use this API to fetch filtered set of nsassignment resources.
	...
	def count(cls, client) :
		""" Use this API to count the nsassignment resources configured on NetScaler.
		"""
		try :
			obj = nsassignment()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		""" Use this API to count filtered the set of nsassignment resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = nsassignment()
