...
class nstcpprofile(base_resource) :
	...
	@property
	def minrto(self) :
		"""Minimum retransmission timeout, in milliseconds.<br/>Default value: 1000<br/>Minimum length =  10<br/>Maximum length =  64000.
		"""
		try :
			return self._minrto
		except Exception as e:
	...
	@property
	def buffersize(self) :
		"""TCP buffering size, in bytes.<br/>Default value: 8190<br/>Minimum length =  8190<br/>Maximum length =  4194304.
		"""
		try :
	...
	@property
	def flavor(self) :
		"""Set TCP congestion control algorithm.<br/>Default value: Default<br/>Possible values = Default, Westwood, BIC, CUBIC.
		"""
		try :
			return self._flavor
		except Exception as e:
	...
	def sendbuffsize(self) :
		"""TCP Send Buffer Size.<br/>Default value: 8190<br/>Minimum length =  8190<br/>Maximum length =  4194304.
		"""
		try :
