...
class nstrafficdomain_bridgegroup_binding(base_resource) :
	...
	def bridgegroup(self) :
		"""ID of the configured bridge to bind to this traffic domain. More than one bridge group can be bound to a traffic domain, but the same bridge group cannot be a part of multiple traffic domains.<br/>Minimum value =  1<br/>Maximum value =  1000.
		"""
		try :
	...
	def get(cls, service, td) :
		""" Use this API to fetch nstrafficdomain_bridgegroup_binding resources.
		"""
		try :
