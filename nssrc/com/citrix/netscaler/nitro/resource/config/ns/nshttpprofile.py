...
class nshttpprofile(base_resource) :
	...
	def incomphdrdelay(self) :
		"""Maximum time to wait, in milliseconds, between incomplete header packets. If the header packets take longer to arrive at NetScaler, the connection is silently dropped.<br/>Default value: 7000<br/>Maximum length =  360000.
		"""
		try :
	...
	@property
	def reqtimeout(self) :
		"""Time, in seconds, within which the HTTP request must complete. If the request does not complete within this time, the specified request timeout action is executed.<br/>Maximum length =  86400.
		"""
		try :
	...
	@property
	def maxreq(self) :
		"""Maximum requests allowed on a single connection.<br/>Default value: 0<br/>Maximum length =  65534.
		"""
		try :
			return self._maxreq
		except Exception as e:
	...
	@property
	def spdy(self) :
		"""Enable SPDYv2 or SPDYv3 or both over SSL vserver. SSL will advertise SPDY support during NPN Handshake. Both SPDY versions are enabled when this parameter is set to BOTH.<br/>Default value: DISABLED<br/>Possible values = DISABLED, ENABLED, V2, V3.
		"""
		try :
			return self._spdy
		except Exception as e:
