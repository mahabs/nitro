...
class nslimitidentifier(base_resource) :
	...
	@property
	def timeslice(self) :
		"""Time interval, in milliseconds, specified in multiples of 10, during which requests are tracked to check if they cross the threshold. This argument is needed only when the mode is set to REQUEST_RATE.<br/>Default value: 1000<br/>Minimum length =  10.
		"""
		try :
	...
	def maxbandwidth(self) :
		"""Maximum bandwidth permitted, in kbps.<br/>Maximum length =  4294967287.
		"""
		try :
	...
	def trapsintimeslice(self) :
		"""Number of traps to be sent in the timeslice configured. A value of 0 indicates that traps are disabled.<br/>Maximum length =  65535.
		"""
		try :
