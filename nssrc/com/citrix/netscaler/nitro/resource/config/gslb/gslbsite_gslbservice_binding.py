...
class gslbsite_gslbservice_binding(base_resource) :
	...
	def servicetype(self) :
		"""Service type.<br/>Possible values = HTTP, FTP, TCP, UDP, SSL, SSL_BRIDGE, SSL_TCP, DTLS, NNTP, DNS, DHCPRA, ANY, SIP_UDP, DNS_TCP, RTSP, PUSH, SSL_PUSH, RADIUS, RDP, MYSQL, MSSQL, DIAMETER, SSL_DIAMETER, TFTP, ORACLE.
		"""
		try :
	...
	def get(cls, service, sitename) :
		""" Use this API to fetch gslbsite_gslbservice_binding resources.
		"""
		try :
