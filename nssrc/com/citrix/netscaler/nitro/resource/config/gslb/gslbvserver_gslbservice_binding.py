...
class gslbvserver_gslbservice_binding(base_resource) :
	...
	def svcsitepersistence(self) :
		"""Type of Site Persistence set on the bound service.<br/>Possible values = ConnectionProxy, HTTPRedirect, NONE.
		"""
		try :
	...
	def gslbboundsvctype(self) :
		"""Protocol used by services bound to the GSLBvirtual server.<br/>Possible values = HTTP, FTP, TCP, UDP, SSL, SSL_BRIDGE, SSL_TCP, NNTP, ANY, SIP_UDP, RADIUS, RDP, RTSP, MYSQL, MSSQL, ORACLE.
		"""
		try :
	...
	def sitepersistcookie(self) :
		"""This field is introduced for displaying the cookie in cluster setup.<br/>Minimum length =  1.
		"""
		try :
	...
	def get(cls, service, name) :
		""" Use this API to fetch gslbvserver_gslbservice_binding resources.
		"""
		try :
