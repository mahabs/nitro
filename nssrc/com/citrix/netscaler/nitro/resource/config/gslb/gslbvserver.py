...
class gslbvserver(base_resource) :
	...
	def servicetype(self) :
		"""Protocol used by services bound to the virtual server.<br/>Possible values = HTTP, FTP, TCP, UDP, SSL, SSL_BRIDGE, SSL_TCP, NNTP, ANY, SIP_UDP, RADIUS, RDP, RTSP, MYSQL, MSSQL, ORACLE.
		"""
		try :
	...
	def backupsessiontimeout(self) :
		"""A non zero value enables the feature whose minimum value is 2 minutes. The feature can be disabled by setting the value to zero. The created session is in effect for a specific client per domain.<br/>Maximum length =  1440.
		"""
		try :
	...
	def v6netmasklen(self) :
		"""Number of bits to consider, in an IPv6 source IP address, for creating the hash that is required by the SOURCEIPHASH load balancing method.<br/>Default value: 128<br/>Minimum length =  1<br/>Maximum length =  128.
		"""
		try :
	...
	def persistenceid(self) :
		"""The persistence ID for the GSLB virtual server. The ID is a positive integer that enables GSLB sites to identify the GSLB virtual server, and is required if source IP address based or spill over based persistence is enabled on the virtual server.<br/>Maximum length =  65535.
		"""
		try :
	...
	def v6persistmasklen(self) :
		"""Number of bits to consider in an IPv6 source IP address when creating source IP address based persistence sessions.<br/>Default value: 128<br/>Minimum length =  1<br/>Maximum length =  128.
		"""
		try :
	...
	@property
	def timeout(self) :
		"""Idle time, in minutes, after which a persistence entry is cleared.<br/>Default value: 2<br/>Minimum length =  2<br/>Maximum length =  1440.
		"""
		try :
	...
	@property
	def weight(self) :
		"""Weight to assign to the GSLB service.<br/>Minimum length =  1<br/>Maximum length =  100.
		"""
		try :
			return self._weight
		except Exception as e:
	...
	@property
	def ttl(self) :
		"""Time to live (TTL) for the domain.<br/>Minimum length =  1.
		"""
		try :
			return self._ttl
		except Exception as e:
	...
	def cookietimeout(self) :
		"""Timeout, in minutes, for the GSLB site cookie.<br/>Maximum length =  1440.
		"""
		try :
	...
	def sitedomainttl(self) :
		"""TTL, in seconds, for all internally created site domains (created when a site prefix is configured on a GSLB service) that are associated with this virtual server.<br/>Minimum length =  1.
		"""
		try :
