...
class gslbparameter(base_resource) :
	...
	def ldnsentrytimeout(self) :
		"""Time, in seconds, after which an inactive LDNS entry is removed.<br/>Default value: 180<br/>Minimum length =  30<br/>Maximum length =  65534.
		"""
		try :
	...
	def v6ldnsmasklen(self) :
		"""Mask for creating LDNS entries for IPv6 source addresses. The mask is defined as the number of leading bits to consider, in the source IP address, when creating an LDNS entry.<br/>Default value: 128<br/>Minimum length =  1<br/>Maximum length =  128.
		"""
		try :
