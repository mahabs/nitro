...
class lldpneighbors(base_resource) :
	...
	def chassisidsubtype(self) :
		"""Chassis id sub type.<br/>Possible values = NONE, Component, Interface Alias, Port Component, MAC Address, Network Address, Interface Name, Locally Assigned.
		"""
		try :
	...
	def portidsubtype(self) :
		"""Port id subtype.<br/>Possible values = NONE, Interface Alias, Port Component, MAC Address, Network Address, Interface Name, Agent Circuit ID, Locally Assigned.
		"""
		try :
	...
	def mgmtaddresssubtype(self) :
		"""Management Address Type.<br/>Possible values = OTHER, IPv4, IPv6.
		"""
		try :
	...
	@property
	def iftype(self) :
		"""Interface subtype.<br/>Possible values = UNKNOWN, ifIndex, system port number.
		"""
		try :
			return self._iftype
		except Exception as e:
	...
	def linkaggrcapable(self) :
		"""Is neighbor Link Aggregation Capable.<br/>Possible values = NO, YES.
		"""
		try :
	...
	def linkaggrenabled(self) :
		"""Is link aggregation Enabled.<br/>Possible values = NO, YES.
		"""
		try :
	...
	def autonegsupport(self) :
		"""MAC/PHY autonegotiation support.<br/>Possible values = NO, YES.
		"""
		try :
	...
	def autonegenabled(self) :
		"""MAC/PHY autonegotiation enabled.<br/>Possible values = NO, YES.
		"""
		try :
	...
	def clear(cls, client, resource="") :
		""" Use this API to clear lldpneighbors.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		""" Use this API to fetch all the lldpneighbors resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = lldpneighbors()
	...
	def get_filtered(cls, client, filter_) :
		""" Use this API to fetch filtered set of lldpneighbors resources.
	...
	def count(cls, client) :
		""" Use this API to count the lldpneighbors resources configured on NetScaler.
		"""
		try :
			obj = lldpneighbors()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		""" Use this API to count filtered the set of lldpneighbors resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = lldpneighbors()
