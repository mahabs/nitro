...
class dnszone_domain_binding(base_resource) :
	...
	@property
	def nextrecs(self) :
		"""An array of record types associated with the nsec record.<br/>Possible values = A, NS, CNAME, SOA, MX, AAAA, SRV, RRSIG, NSEC, DNSKEY, PTR, TXT, NAPTR.
		"""
		try :
	...
	def get(cls, service, zonename) :
		""" Use this API to fetch dnszone_domain_binding resources.
		"""
		try :
