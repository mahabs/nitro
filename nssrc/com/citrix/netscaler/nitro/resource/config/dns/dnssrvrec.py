...
class dnssrvrec(base_resource) :
	...
	@property
	def priority(self) :
		"""Integer specifying the priority of the target host. The lower the number, the higher the priority. If multiple target hosts have the same priority, selection is based on the Weight parameter.<br/>Maximum length =  65535.
		"""
		try :
	...
	@property
	def weight(self) :
		"""Weight for the target host. Aids host selection when two or more hosts have the same priority. A larger number indicates greater weight.<br/>Maximum length =  65535.
		"""
		try :
			return self._weight
		except Exception as e:
	...
	@property
	def port(self) :
		"""Port on which the target host listens for client requests.<br/>Maximum length =  65535.
		"""
		try :
			return self._port
		except Exception as e:
