...
class dnskey(base_resource) :
	...
	@property
	def expires(self) :
		"""Time period for which to consider the key valid, after the key is used to sign a zone.<br/>Default value: 120<br/>Minimum length =  1<br/>Maximum length =  32767.
		"""
		try :
	...
	@property
	def ttl(self) :
		"""Time to Live (TTL), in seconds, for the DNSKEY resource record created in the zone. TTL is the time for which the record must be cached by the DNS proxies. If the TTL is not specified, either the DNS zone's minimum TTL or the default value of 3600 is used.<br/>Default value: 3600<br/>Maximum length =  2147483647.
		"""
		try :
			return self._ttl
		except Exception as e:
