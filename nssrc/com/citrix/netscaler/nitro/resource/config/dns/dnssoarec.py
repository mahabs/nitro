...
class dnssoarec(base_resource) :
	...
	@property
	def serial(self) :
		"""The secondary server uses this parameter to determine whether it requires a zone transfer from the primary server.<br/>Default value: 100<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
			return self._serial
		except Exception as e:
	...
	@property
	def refresh(self) :
		"""Time, in seconds, for which a secondary server must wait between successive checks on the value of the serial number.<br/>Default value: 3600<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
	...
	@property
	def retry(self) :
		"""Time, in seconds, between retries if a secondary server's attempt to contact the primary server for a zone refresh fails.<br/>Default value: 3<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
			return self._retry
		except Exception as e:
	...
	@property
	def minimum(self) :
		"""Default time to live (TTL) for all records in the zone. Can be overridden for individual records.<br/>Default value: 5<br/>Maximum length =  2147483647.
		"""
		try :
