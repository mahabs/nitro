...
class dnstxtrec(base_resource) :
	...
	@property
	def recordid(self) :
		"""Unique, internally generated record ID. View the details of the TXT record to obtain its record ID. Mutually exclusive with the string parameter.<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
