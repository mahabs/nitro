...
class clusterinstance(base_resource) :
	...
	@property
	def clid(self) :
		"""Unique number that identifies the cluster.<br/>Minimum length =  1<br/>Maximum length =  16.
		"""
		try :
			return self._clid
	...
	def deadinterval(self) :
		"""Amount of time, in seconds, after which nodes that do not respond to the heartbeats are assumed to be down.<br/>Default value: 3<br/>Minimum length =  3<br/>Maximum length =  60.
		"""
		try :
	...
	def hellointerval(self) :
		"""Interval, in milliseconds, at which heartbeats are sent to each cluster node to check the health status.<br/>Default value: 200<br/>Minimum length =  200<br/>Maximum length =  1000.
		"""
		try :
	...
	@property
	def quorumtype(self) :
		"""Quorum Configuration Choices  - "Majority" (recommended) requires majority of nodes to be online for the cluster to be UP. "None" relaxes this requirement.<br/>Default value: MAJORITY<br/>Possible values = MAJORITY, NONE.
		"""
		try :
