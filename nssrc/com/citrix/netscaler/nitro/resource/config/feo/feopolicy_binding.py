...
class feopolicy_binding(base_resource):
	...
	def feopolicy_csvserver_bindings(self) :
		"""csvserver that can be bound to feopolicy.
		"""
		try :
	...
	def feopolicy_lbvserver_bindings(self) :
		"""lbvserver that can be bound to feopolicy.
		"""
		try :
	...
	def feopolicy_feoglobal_bindings(self) :
		"""feoglobal that can be bound to feopolicy.
		"""
		try :
	...
	def get(self, service, name) :
		""" Use this API to fetch feopolicy_binding resource.
		"""
		try :
