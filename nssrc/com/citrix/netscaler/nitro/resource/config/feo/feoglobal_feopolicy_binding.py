...
class feoglobal_feopolicy_binding(base_resource) :
	...
	@classmethod
	def get(cls, service) :
		""" Use this API to fetch a feoglobal_feopolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		""" Use this API to fetch filtered set of feoglobal_feopolicy_binding resources.
	...
	def count(cls, service) :
		""" Use this API to count feoglobal_feopolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = feoglobal_feopolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		""" Use this API to count the filtered set of feoglobal_feopolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = feoglobal_feopolicy_binding()
