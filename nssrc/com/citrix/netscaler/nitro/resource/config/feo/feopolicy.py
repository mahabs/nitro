...
class feopolicy(base_resource) :
	...
	@property
	def name(self) :
		"""The name of the front end optimization policy.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	@property
	def action(self) :
		"""The front end optimization action that has to be performed when the rule matches.<br/>Minimum length =  1.
		"""
		try :
			return self._action
		except Exception as e:
	...
	@property
	def builtin(self) :
		"""Flag to determine if the front end optimization policy is built-in or not.<br/>Possible values = MODIFIABLE, DELETABLE, IMMUTABLE, PARTITION_ALL.
		"""
		try :
	...
	def delete(cls, client, resource) :
		""" Use this API to delete feopolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		""" Use this API to update feopolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		""" Use this API to unset the properties of feopolicy resource.
	...
	def get(cls, client, name="", option_="") :
		""" Use this API to fetch all the feopolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = feopolicy()
	...
	def get_filtered(cls, client, filter_) :
		""" Use this API to fetch filtered set of feopolicy resources.
	...
	def count(cls, client) :
		""" Use this API to count the feopolicy resources configured on NetScaler.
		"""
		try :
			obj = feopolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		""" Use this API to count filtered the set of feopolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = feopolicy()
