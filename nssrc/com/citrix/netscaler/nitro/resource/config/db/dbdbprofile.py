...
class dbdbprofile(base_resource) :
	...
	def interpretquery(self) :
		"""If ENABLED, inspect the query and update the connection information, if required. If DISABLED, forward the query to the server.<br/>Default value: YES<br/>Possible values = YES, NO.
		"""
		try :
	...
	@property
	def stickiness(self) :
		"""If the queries are related to each other, forward to the same backend server.<br/>Default value: NO<br/>Possible values = YES, NO.
		"""
		try :
	...
	@property
	def kcdaccount(self) :
		"""Name of the KCD account that is used for Windows authentication.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	def conmultiplex(self) :
		"""Use the same server-side connection for multiple client-side requests. Default is enabled.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def enablecachingconmuxoff(self) :
		"""Enable caching when connection multiplexing is OFF.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
