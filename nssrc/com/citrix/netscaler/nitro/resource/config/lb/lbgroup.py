...
class lbgroup(base_resource) :
	...
	def backuppersistencetimeout(self) :
		"""Time period, in minutes, for which backup persistence is in effect.<br/>Default value: 2<br/>Minimum length =  2<br/>Maximum length =  1440.
		"""
		try :
	...
	def v6persistmasklen(self) :
		"""Persistence mask to apply to source IPv6 addresses when creating source IP based persistence sessions.<br/>Default value: 128<br/>Minimum length =  1<br/>Maximum length =  128.
		"""
		try :
