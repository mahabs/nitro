...
class lbvserver(base_resource) :
	...
	@property
	def timeout(self) :
		"""Time period for which a persistence session is in effect.<br/>Default value: 2<br/>Maximum length =  1440.
		"""
		try :
	...
	def backuppersistencetimeout(self) :
		"""Time period for which backup persistence is in effect.<br/>Default value: 2<br/>Minimum length =  2<br/>Maximum length =  1440.
		"""
		try :
	...
	@property
	def hashlength(self) :
		"""Number of bytes to consider for the hash value used in the URLHASH and DOMAINHASH load balancing methods.<br/>Default value: 80<br/>Minimum length =  1<br/>Maximum length =  4096.
		"""
		try :
	...
	def v6netmasklen(self) :
		"""Number of bits to consider in an IPv6 destination or source IP address, for creating the hash that is required by the DESTINATIONIPHASH and SOURCEIPHASH load balancing methods.<br/>Default value: 128<br/>Minimum length =  1<br/>Maximum length =  128.
		"""
		try :
	...
	def v6persistmasklen(self) :
		"""Persistence mask for IP based persistence types, for IPv6 virtual servers.<br/>Default value: 128<br/>Minimum length =  1<br/>Maximum length =  128.
		"""
		try :
	...
	@property
	def tosid(self) :
		"""TOS ID of the virtual server. Applicable only when the load balancing redirection mode is set to TOS.<br/>Minimum length =  1<br/>Maximum length =  63.
		"""
		try :
			return self._tosid
		except Exception as e:
	...
	@property
	def datalength(self) :
		"""Length of the token to be extracted from the data segment of an incoming packet, for use in the token method of load balancing. The length of the token, specified in bytes, must not be greater than 24 KB. Applicable to virtual servers of type TCP.<br/>Minimum length =  1<br/>Maximum length =  100.
		"""
		try :
	...
	@property
	def dataoffset(self) :
		"""Offset to be considered when extracting a token from the TCP payload. Applicable to virtual servers, of type TCP, using the token method of load balancing. Must be within the first 24 KB of the TCP payload.<br/>Maximum length =  25400.
		"""
		try :
	...
	@property
	def clttimeout(self) :
		"""Idle time, in seconds, after which a client connection is terminated.<br/>Maximum length =  31536000.
		"""
		try :
	...
	def sopersistencetimeout(self) :
		"""Timeout for spillover persistence, in minutes.<br/>Default value: 2<br/>Minimum length =  2<br/>Maximum length =  1440.
		"""
		try :
	...
	def healththreshold(self) :
		"""Threshold in percent of active services below which vserver state is made down. If this threshold is 0, vserver state will be up even if one bound service is up.<br/>Default value: 0<br/>Maximum length =  100.
		"""
		try :
	...
	def sothreshold(self) :
		"""Threshold at which spillover occurs. Specify an integer for the CONNECTION spillover method, a bandwidth value in kilobits per second for the BANDWIDTH method (do not enter the units), or a percentage for the HEALTH method (do not enter the percentage symbol).<br/>Minimum length =  1<br/>Maximum length =  4294967287.
		"""
		try :
	...
	def newservicerequestincrementinterval(self) :
		"""Interval, in seconds, between successive increments in the load on a new service or a service whose state has just changed from DOWN to UP. A value of 0 (zero) specifies manual slow start.<br/>Default value: 0<br/>Maximum length =  3600.
		"""
		try :
	...
	def minautoscalemembers(self) :
		"""Minimum number of members expected to be present when vserver is used in Autoscale.<br/>Default value: 0<br/>Maximum length =  5000.
		"""
		try :
	...
	def maxautoscalemembers(self) :
		"""Maximum number of members expected to be present when vserver is used in Autoscale.<br/>Default value: 0<br/>Maximum length =  5000.
		"""
		try :
	...
	@property
	def dbslb(self) :
		"""Enable database specific load balancing for MySQL and MSSQL service types.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
			return self._dbslb
		except Exception as e:
	...
	@property
	def weight(self) :
		"""Weight to assign to the specified service.<br/>Minimum length =  1<br/>Maximum length =  100.
		"""
		try :
			return self._weight
		except Exception as e:
