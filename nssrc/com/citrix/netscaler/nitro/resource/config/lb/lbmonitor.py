...
class lbmonitor(base_resource) :
	...
	def maxforwards(self) :
		"""Maximum number of hops that the SIP request used for monitoring can traverse to reach the server. Applicable only to monitors of type SIP-UDP.<br/>Default value: 1<br/>Maximum length =  255.
		"""
		try :
	...
	@property
	def username(self) :
		"""User name with which to probe the RADIUS, NNTP, FTP, FTP-EXTENDED, MYSQL, MSSQL, POP3, CITRIX-AG, CITRIX-XD-DDC, CITRIX-WI-EXTENDED, CITRIX-XNC or CITRIX-XDM server.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def password(self) :
		"""Password that is required for logging on to the RADIUS, NNTP, FTP, FTP-EXTENDED, MYSQL, MSSQL, POP3, CITRIX-AG, CITRIX-XD-DDC, CITRIX-WI-EXTENDED, CITRIX-XNC-ECV or CITRIX-XDM server. Used in conjunction with the user name specified for the User Name parameter.<br/>Minimum length =  1.
		"""
		try :
	...
	def radaccounttype(self) :
		"""Account Type to be used in Account Request Packet. Applicable to monitors of type RADIUS_ACCOUNTING.<br/>Default value: 1<br/>Maximum length =  15.
		"""
		try :
	...
	@property
	def deviation(self) :
		"""Time value added to the learned average response time in dynamic response time monitoring (DRTM). When a deviation is specified, the appliance learns the average response time of bound services and adds the deviation to the average. The final value is then continually adjusted to accommodate response time variations over time. Specified in milliseconds, seconds, or minutes.<br/>Maximum length =  20939000.
		"""
		try :
	...
	@property
	def interval(self) :
		"""Time interval between two successive probes. Must be greater than the value of Response Time-out.<br/>Default value: 5<br/>Minimum length =  1<br/>Maximum length =  20940000.
		"""
		try :
	...
	@property
	def retries(self) :
		"""Maximum number of probes to send to establish the state of a service for which a monitoring probe failed.<br/>Default value: 3<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
	...
	def alertretries(self) :
		"""Number of consecutive probe failures after which the appliance generates an SNMP trap called monProbeFailed.<br/>Maximum length =  32.
		"""
		try :
	...
	def successretries(self) :
		"""Number of consecutive successful probes required to transition a service's state from DOWN to UP.<br/>Default value: 1<br/>Minimum length =  1<br/>Maximum length =  32.
		"""
		try :
	...
	@property
	def downtime(self) :
		"""Time duration for which to wait before probing a service that has been marked as DOWN. Expressed in milliseconds, seconds, or minutes.<br/>Default value: 30<br/>Minimum length =  1<br/>Maximum length =  20939000.
		"""
		try :
	...
	@property
	def tosid(self) :
		"""The TOS ID of the specified destination IP. Applicable only when the TOS parameter is set.<br/>Minimum length =  1<br/>Maximum length =  63.
		"""
		try :
			return self._tosid
		except Exception as e:
	...
	@property
	def database(self) :
		"""Name of the database to connect to during authentication.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def oraclesid(self) :
		"""Name of the service identifier that is used to connect to the Oracle database during authentication.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def sitepath(self) :
		"""URL of the logon page. For monitors of type CITRIX-WEB-INTERFACE, to monitor a dynamic page under the site path, terminate the site path with a slash (/). Applicable to CITRIX-WEB-INTERFACE, CITRIX-WI-EXTENDED and CITRIX-XDM monitors.<br/>Minimum length =  1.
		"""
		try :
	...
	def authapplicationid(self) :
		"""List of Auth-Application-Id attribute value pairs (AVPs) for the Capabilities-Exchange-Request (CER) message to use for monitoring Diameter servers. A maximum of eight of these AVPs are supported in a monitoring CER message.<br/>Maximum length =  0xFFFFFFFF.
		"""
		try :
	...
	def acctapplicationid(self) :
		"""List of Acct-Application-Id attribute value pairs (AVPs) for the Capabilities-Exchange-Request (CER) message to use for monitoring Diameter servers. A maximum of eight of these AVPs are supported in a monitoring message.<br/>Maximum length =  0xFFFFFFFF.
		"""
		try :
	...
	def supportedvendorids(self) :
		"""List of Supported-Vendor-Id attribute value pairs (AVPs) for the Capabilities-Exchange-Request (CER) message to use for monitoring Diameter servers. A maximum eight of these AVPs are supported in a monitoring message.<br/>Minimum length =  1<br/>Maximum length =  0xFFFFFFFF.
		"""
		try :
	...
	@property
	def storedb(self) :
		"""Store the database list populated with the responses to monitor probes. Used in database specific load balancing if MSSQL-ECV/MYSQL-ECV  monitor is configured.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def metricweight(self) :
		"""The weight for the specified service metric with respect to others.<br/>Minimum length =  1<br/>Maximum length =  100.
		"""
		try :
	...
	def lrtmconfstr(self) :
		"""State of LRTM configuration on the monitor as STRING.<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
