...
class cachepolicy_csvserver_binding(base_resource) :
	...
	def get(cls, service, policyname) :
		""" Use this API to fetch cachepolicy_csvserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, policyname, filter_) :
		""" Use this API to fetch filtered set of cachepolicy_csvserver_binding resources.
	...
	def count(cls, service, policyname) :
		""" Use this API to count cachepolicy_csvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = cachepolicy_csvserver_binding()
			obj.policyname = policyname
	...
	def count_filtered(cls, service, policyname, filter_) :
		""" Use this API to count the filtered set of cachepolicy_csvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = cachepolicy_csvserver_binding()
