...
class appfwxmlerrorpage(base_resource) :
	...
	@property
	def comment(self) :
		"""Any comments to preserve information about the XML error object.<br/>Maximum length =  128.
		"""
		try :
	...
	def delete(cls, client, resource) :
		""" Use this API to delete appfwxmlerrorpage.
		"""
		try :
	...
	def Import(cls, client, resource) :
		""" Use this API to Import appfwxmlerrorpage.
		"""
		try :
			if type(resource) is not list :
