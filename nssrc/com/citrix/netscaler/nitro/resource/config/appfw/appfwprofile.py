...
class appfwprofile(base_resource) :
	...
	def sqlinjectionchecksqlwildchars(self) :
		"""Check for form fields that contain SQL wild chars .<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def defaultfieldformatmaxlength(self) :
		"""Maximum length, in characters, for data entered into a field that is assigned the default field type.<br/>Default value: 65535<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
	...
	def bufferoverflowmaxurllength(self) :
		"""Maximum length, in characters, for URLs on your protected web sites. Requests with longer URLs are blocked.<br/>Default value: 1024<br/>Minimum length =  0<br/>Maximum length =  65535.
		"""
		try :
	...
	def bufferoverflowmaxheaderlength(self) :
		"""Maximum length, in characters, for HTTP headers in requests sent to your protected web sites. Requests with longer headers are blocked.<br/>Default value: 4096<br/>Minimum length =  0<br/>Maximum length =  65535.
		"""
		try :
	...
	def bufferoverflowmaxcookielength(self) :
		"""Maximum length, in characters, for cookies sent to your protected web sites. Requests with longer cookies are blocked.<br/>Default value: 4096<br/>Minimum length =  0<br/>Maximum length =  65535.
		"""
		try :
	...
	def creditcardmaxallowed(self) :
		"""Maximum number of credit card numbers that can appear on a web page served by your protected web sites. Pages that contain more credit card numbers are blocked, or the credit card numbers are masked.<br/>Maximum length =  255.
		"""
		try :
	...
	def postbodylimit(self) :
		"""Maximum allowed HTTP post body size, in bytes.<br/>Default value: 20000000<br/>Maximum length =  1000000000.
		"""
		try :
	...
	def fileuploadmaxnum(self) :
		"""Maximum allowed number of file uploads per form-submission request. The maximum setting (65535) allows an unlimited number of uploads.<br/>Default value: 65535<br/>Maximum length =  65535.
		"""
		try :
	...
	def urldecoderequestcookies(self) :
		"""URL Decode request cookies before subjecting them to SQL and cross-site scripting checks.<br/>Default value: OFF<br/>Possible values = ON, OFF.
		"""
		try :
