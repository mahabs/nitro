...
class service(base_resource) :
	...
	def servicetype(self) :
		"""Protocol in which data is exchanged with the service.<br/>Possible values = HTTP, FTP, TCP, UDP, SSL, SSL_BRIDGE, SSL_TCP, DTLS, NNTP, RPCSVR, DNS, ADNS, SNMP, RTSP, DHCPRA, ANY, SIP_UDP, DNS_TCP, ADNS_TCP, MYSQL, MSSQL, ORACLE, RADIUS, RDP, DIAMETER, SSL_DIAMETER, TFTP.
		"""
		try :
	...
	def cleartextport(self) :
		"""Port to which clear text data must be sent after the appliance decrypts incoming SSL traffic. Applicable to transparent SSL services.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def maxclient(self) :
		"""Maximum number of simultaneous open connections to the service.<br/>Maximum length =  4294967294.
		"""
		try :
	...
	def maxbandwidth(self) :
		"""Maximum bandwidth, in Kbps, allocated to the service.<br/>Maximum length =  4294967287.
		"""
		try :
	...
	def downstateflush(self) :
		"""Flush all active transactions associated with a service whose state transitions from UP to DOWN. Do not enable this option for applications that must complete their transactions.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def hashid(self) :
		"""A numerical identifier that can be used by hash based load balancing methods. Must be unique for each service.<br/>Minimum length =  1.
		"""
		try :
			return self._hashid
		except Exception as e:
