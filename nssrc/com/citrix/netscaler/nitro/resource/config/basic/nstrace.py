...
class nstrace(base_resource) :
	...
	@property
	def nf(self) :
		"""Number of files to be generated in cycle.<br/>Default value: 24<br/>Minimum length =  1<br/>Maximum length =  100.
		"""
		try :
			return self._nf
	...
	@property
	def time(self) :
		"""Time per file (sec).<br/>Default value: 3600<br/>Minimum length =  1.
		"""
		try :
			return self._time
		except Exception as e:
	...
	@property
	def size(self) :
		"""Size of the captured data. Set 0 for full packet trace.<br/>Default value: 164<br/>Maximum length =  1514.
		"""
		try :
			return self._size
		except Exception as e:
	...
	def doruntimemerge(self) :
		"""Enable or disable runtime merge.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def doruntimecleanup(self) :
		"""Enable or disable runtime temp file cleanup.<br/>Default value: ENABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def tracebuffers(self) :
		"""Number of 16KB trace buffers.<br/>Default value: 5000<br/>Minimum length =  1000.
		"""
		try :
	...
	@property
	def skiprpc(self) :
		"""skip RPC packets.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def inmemorytrace(self) :
		"""Logs packets in appliance's memory and dumps the trace file on stopping the nstrace operation.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	@property
	def state(self) :
		"""Current running state of trace.<br/>Default value: 0<br/>Possible values = RUNNING, STOPPED.
		"""
		try :
			return self._state
		except Exception as e:
	...
	@property
	def scope(self) :
		"""Scope of started trace, local or cluster level.<br/>Default value: 0<br/>Possible values = CLUSTER, LOCAL.
		"""
		try :
			return self._scope
		except Exception as e:
