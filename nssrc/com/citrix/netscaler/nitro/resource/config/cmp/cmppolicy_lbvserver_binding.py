...
class cmppolicy_lbvserver_binding(base_resource) :
	...
	def get(cls, service, name) :
		""" Use this API to fetch cmppolicy_lbvserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		""" Use this API to fetch filtered set of cmppolicy_lbvserver_binding resources.
	...
	def count(cls, service, name) :
		""" Use this API to count cmppolicy_lbvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = cmppolicy_lbvserver_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		""" Use this API to count the filtered set of cmppolicy_lbvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = cmppolicy_lbvserver_binding()
