...
class cmpaction(base_resource) :
	...
	def addvaryheader(self) :
		"""Control insertion of the Vary header in HTTP responses compressed by NetScaler. Intermediate caches store different versions of the response for different values of the headers present in the Vary response header.<br/>Default value: GLOBAL<br/>Possible values = GLOBAL, DISABLED, ENABLED.
		"""
		try :
	...
	def varyheadervalue(self) :
		"""The value of the HTTP Vary header for compressed responses.<br/>Minimum length =  1.
		"""
		try :
	...
	def update(cls, client, resource) :
		""" Use this API to update cmpaction.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		""" Use this API to unset the properties of cmpaction resource.
