...
class cmppolicylabel_policybinding_binding(base_resource) :
	...
	def get(cls, service, labelname) :
		""" Use this API to fetch cmppolicylabel_policybinding_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, labelname, filter_) :
		""" Use this API to fetch filtered set of cmppolicylabel_policybinding_binding resources.
	...
	def count(cls, service, labelname) :
		""" Use this API to count cmppolicylabel_policybinding_binding resources configued on NetScaler.
		"""
		try :
			obj = cmppolicylabel_policybinding_binding()
			obj.labelname = labelname
	...
	def count_filtered(cls, service, labelname, filter_) :
		""" Use this API to count the filtered set of cmppolicylabel_policybinding_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = cmppolicylabel_policybinding_binding()
