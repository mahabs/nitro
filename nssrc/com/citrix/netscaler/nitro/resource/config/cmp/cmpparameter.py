...
class cmpparameter(base_resource) :
	...
	def quantumsize(self) :
		"""Minimum quantum of data to be filled before compression begins.<br/>Default value: 57344<br/>Minimum length =  8<br/>Maximum length =  63488.
		"""
		try :
	...
	def heurexpirythres(self) :
		"""Threshold compression ratio for heuristic basefile expiry, multiplied by 100. For example, to set the threshold ratio to 1.25, specify 125.<br/>Default value: 100<br/>Minimum length =  1<br/>Maximum length =  1000.
		"""
		try :
	...
	def cmpbypasspct(self) :
		"""NetScaler CPU threshold after which compression is not performed. Range: 0 - 100.<br/>Default value: 100<br/>Maximum length =  100.
		"""
		try :
	...
	def addvaryheader(self) :
		"""Control insertion of the Vary header in HTTP responses compressed by NetScaler. Intermediate caches store different versions of the response for different values of the headers present in the Vary response header.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def varyheadervalue(self) :
		"""The value of the HTTP Vary header for compressed responses. If this argument is not specified, a default value of "Accept-Encoding" will be used.<br/>Minimum length =  1.
		"""
		try :
