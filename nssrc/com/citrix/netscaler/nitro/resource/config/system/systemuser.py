...
class systemuser(base_resource) :
	...
	@property
	def logging(self) :
		"""Users logging privilege.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
	...
	def promptinheritedfrom(self) :
		"""From where the prompt has been inherited.<br/>Possible values = User, Group, Global, Climode.
		"""
		try :
	...
	def timeoutkind(self) :
		"""From where the timeout has been inherited.<br/>Possible values = User, Group, Global, Climode.
		"""
		try :
