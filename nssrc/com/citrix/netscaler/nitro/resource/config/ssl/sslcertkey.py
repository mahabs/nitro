...
class sslcertkey(base_resource) :
	...
	def notificationperiod(self) :
		"""Time, in number of days, before certificate expiration, at which to generate an alert that the certificate is about to expire.<br/>Minimum length =  10<br/>Maximum length =  100.
		"""
		try :
