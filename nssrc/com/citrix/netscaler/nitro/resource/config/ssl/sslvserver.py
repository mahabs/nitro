...
class sslvserver(base_resource) :
	...
	def cleartextport(self) :
		"""Port on which clear-text data is sent by the appliance to the server. Do not specify this parameter for SSL offloading with end-to-end encryption.<br/>Default value: 0.
		"""
		try :
	...
	@property
	def dhcount(self) :
		"""Number of interactions, between the client and the NetScaler appliance, after which the DH private-public pair is regenerated. A value of zero (0) specifies infinite use (no refresh).<br/>Maximum length =  65534.
		"""
		try :
	...
	@property
	def ersacount(self) :
		"""Refresh count for regeneration of the RSA public-key and private-key pair. Zero (0) specifies infinite usage (no refresh).<br/>Maximum length =  65534.
		"""
		try :
	...
	def sesstimeout(self) :
		"""Time, in seconds, for which to keep the session active. Any session resumption request received after the timeout period will require a fresh SSL handshake and establishment of a new SSL session.<br/>Default value: 120<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
	...
	@property
	def sslprofile(self) :
		"""SSL profile associated to vserver.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
