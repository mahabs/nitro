...
class sslcertfile(base_resource) :
	...
	def Import(cls, client, resource) :
		""" Use this API to Import sslcertfile.
		"""
		try :
	...
	def delete(cls, client, resource) :
		""" Use this API to delete sslcertfile.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		""" Use this API to fetch all the sslcertfile resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = sslcertfile()
	...
	def get_filtered(cls, client, filter_) :
		""" Use this API to fetch filtered set of sslcertfile resources.
	...
	def count(cls, client) :
		""" Use this API to count the sslcertfile resources configured on NetScaler.
		"""
		try :
			obj = sslcertfile()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		""" Use this API to count filtered the set of sslcertfile resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslcertfile()
