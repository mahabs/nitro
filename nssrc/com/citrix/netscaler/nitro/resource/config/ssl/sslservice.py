...
class sslservice(base_resource) :
	...
	@property
	def dhcount(self) :
		"""Number of interactions, between the client and the NetScaler appliance, after which the DH private-public pair is regenerated. A value of zero (0) specifies infinite use (no refresh). This parameter is not applicable when configuring a backend service.<br/>Maximum length =  65534.
		"""
		try :
	...
	@property
	def sslprofile(self) :
		"""SSL profile associated to service.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
