...
class sslpolicy_csvserver_binding(base_resource) :
	...
	def get(cls, service, name) :
		""" Use this API to fetch sslpolicy_csvserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		""" Use this API to fetch filtered set of sslpolicy_csvserver_binding resources.
	...
	def count(cls, service, name) :
		""" Use this API to count sslpolicy_csvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = sslpolicy_csvserver_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		""" Use this API to count the filtered set of sslpolicy_csvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslpolicy_csvserver_binding()
