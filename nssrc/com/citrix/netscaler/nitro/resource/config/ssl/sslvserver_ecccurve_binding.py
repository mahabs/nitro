...
class sslvserver_ecccurve_binding(base_resource) :
	...
	def get(cls, service, vservername) :
		""" Use this API to fetch sslvserver_ecccurve_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, vservername, filter_) :
		""" Use this API to fetch filtered set of sslvserver_ecccurve_binding resources.
	...
	def count(cls, service, vservername) :
		""" Use this API to count sslvserver_ecccurve_binding resources configued on NetScaler.
		"""
		try :
			obj = sslvserver_ecccurve_binding()
			obj.vservername = vservername
	...
	def count_filtered(cls, service, vservername, filter_) :
		""" Use this API to count the filtered set of sslvserver_ecccurve_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = sslvserver_ecccurve_binding()
