...
class csvserver(base_resource) :
	...
	def servicetype(self) :
		"""Protocol used by the virtual server.<br/>Possible values = HTTP, SSL, TCP, FTP, RTSP, SSL_TCP, UDP, DNS, SIP_UDP, ANY, RADIUS, RDP, MYSQL, MSSQL, DIAMETER, SSL_DIAMETER, DNS_TCP, ORACLE.
		"""
		try :
	...
	@property
	def range(self) :
		"""Number of consecutive IP addresses, starting with the address specified by the IP Address parameter, to include in a range of addresses assigned to this virtual server.<br/>Default value: 1<br/>Minimum length =  1<br/>Maximum length =  254.
		"""
		try :
			return self._range
		except Exception as e:
	...
	@property
	def port(self) :
		"""Port number for content switching virtual server.<br/>Minimum length =  1<br/>Range 1 - 65535.
		"""
		try :
			return self._port
		except Exception as e:
	...
	def sopersistencetimeout(self) :
		"""Time-out value, in minutes, for spillover persistence.<br/>Default value: 2<br/>Minimum length =  2<br/>Maximum length =  1440.
		"""
		try :
	...
	def sothreshold(self) :
		"""Depending on the spillover method, the maximum number of connections or the maximum total bandwidth (Kbps) that a virtual server can handle before spillover occurs.<br/>Minimum length =  1<br/>Maximum length =  4294967287.
		"""
		try :
