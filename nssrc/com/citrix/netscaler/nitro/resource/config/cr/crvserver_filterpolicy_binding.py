...
class crvserver_filterpolicy_binding(base_resource) :
	...
	@property
	def inherited(self) :
		"""On State describes that policy bound is inherited from global binding.<br/>Possible values = ON, OFF.
		"""
		try :
	...
	def get(cls, service, name) :
		""" Use this API to fetch crvserver_filterpolicy_binding resources.
		"""
		try :
