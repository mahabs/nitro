...
class crvserver(base_resource) :
	...
	@property
	def port(self) :
		"""Port number of the virtual server.<br/>Default value: 80<br/>Minimum length =  1<br/>Maximum length =  65534.
		"""
		try :
			return self._port
		except Exception as e:
	...
	@property
	def range(self) :
		"""Number of consecutive IP addresses, starting with the address specified by the IPAddress parameter, to include in a range of addresses assigned to this virtual server.<br/>Default value: 1<br/>Minimum length =  1<br/>Maximum length =  254.
		"""
		try :
			return self._range
		except Exception as e:
	...
	@property
	def clttimeout(self) :
		"""Time-out value, in seconds, after which to terminate an idle client connection.<br/>Maximum length =  31536000.
		"""
		try :
	...
	def sopersistencetimeout(self) :
		"""Time-out, in minutes, for spillover persistence.<br/>Minimum length =  2<br/>Maximum length =  24.
		"""
		try :
	...
	def listenpriority(self) :
		"""Priority of the listen policy specified by the Listen Policy parameter. The lower the number, higher the priority.<br/>Default value: 101<br/>Maximum length =  100.
		"""
		try :
