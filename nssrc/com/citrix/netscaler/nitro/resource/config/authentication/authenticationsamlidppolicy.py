...
class authenticationsamlidppolicy(base_resource) :
	...
	@property
	def action(self) :
		"""Name of the profile to apply to requests or connections that match this policy.<br/>Minimum length =  1.
		"""
		try :
			return self._action
		except Exception as e:
	...
	def add(cls, client, resource) :
		""" Use this API to add authenticationsamlidppolicy.
		"""
		try :
	...
	def delete(cls, client, resource) :
		""" Use this API to delete authenticationsamlidppolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		""" Use this API to update authenticationsamlidppolicy.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		""" Use this API to unset the properties of authenticationsamlidppolicy resource.
	...
	def rename(cls, client, resource, new_name) :
		""" Use this API to rename a authenticationsamlidppolicy resource.
		"""
		try :
	...
	def get(cls, client, name="", option_="") :
		""" Use this API to fetch all the authenticationsamlidppolicy resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		""" Use this API to fetch filtered set of authenticationsamlidppolicy resources.
	...
	def count(cls, client) :
		""" Use this API to count the authenticationsamlidppolicy resources configured on NetScaler.
		"""
		try :
			obj = authenticationsamlidppolicy()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		""" Use this API to count filtered the set of authenticationsamlidppolicy resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationsamlidppolicy()
