...
class authenticationsamlaction(base_resource) :
	...
	@property
	def attribute1(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute1.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute2(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute2.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute3(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute3.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute4(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute4.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute5(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute5.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute6(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute6.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute7(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute7.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute8(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute8.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute9(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute9.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute10(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute10.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute11(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute11.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute12(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute12.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute13(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute13.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute14(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute14.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute15(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute15.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute16(self) :
		"""Name of the attribute in SAML Assertion whose value needs to be extracted and stored as attribute16.<br/>Maximum length =  64.
		"""
		try :
	...
	def samlbinding(self) :
		"""This element specifies the transport mechanism of saml messages.<br/>Default value: POST<br/>Possible values = REDIRECT, POST.
		"""
		try :
