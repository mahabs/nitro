...
class authenticationwebauthaction(base_resource) :
	...
	@property
	def serverip(self) :
		"""IP address of the web server to be used for authentication.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def serverport(self) :
		"""Port on which the web server accepts connections.<br/>Minimum length =  1<br/>Range 1 - 65535.
		"""
		try :
	...
	@property
	def scheme(self) :
		"""Type of scheme for the web server.<br/>Possible values = http, https.
		"""
		try :
			return self._scheme
		except Exception as e:
	...
	@property
	def attribute1(self) :
		"""Expression that would be evaluated to extract attribute1 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute2(self) :
		"""Expression that would be evaluated to extract attribute2 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute3(self) :
		"""Expression that would be evaluated to extract attribute3 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute4(self) :
		"""Expression that would be evaluated to extract attribute4 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute5(self) :
		"""Expression that would be evaluated to extract attribute5 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute6(self) :
		"""Expression that would be evaluated to extract attribute6 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute7(self) :
		"""Expression that would be evaluated to extract attribute7 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute8(self) :
		"""Expression that would be evaluated to extract attribute8 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	@property
	def attribute9(self) :
		"""Expression that would be evaluated to extract attribute9 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute10(self) :
		"""Expression that would be evaluated to extract attribute10 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute11(self) :
		"""Expression that would be evaluated to extract attribute11 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute12(self) :
		"""Expression that would be evaluated to extract attribute12 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute13(self) :
		"""Expression that would be evaluated to extract attribute13 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute14(self) :
		"""Expression that would be evaluated to extract attribute14 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute15(self) :
		"""Expression that would be evaluated to extract attribute15 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	def attribute16(self) :
		"""Expression that would be evaluated to extract attribute16 from the webauth response.<br/>Maximum length =  64.
		"""
		try :
	...
	def add(cls, client, resource) :
		""" Use this API to add authenticationwebauthaction.
		"""
		try :
	...
	def delete(cls, client, resource) :
		""" Use this API to delete authenticationwebauthaction.
		"""
		try :
			if type(resource) is not list :
	...
	def update(cls, client, resource) :
		""" Use this API to update authenticationwebauthaction.
		"""
		try :
			if type(resource) is not list :
	...
	def unset(cls, client, resource, args) :
		""" Use this API to unset the properties of authenticationwebauthaction resource.
	...
	def get(cls, client, name="", option_="") :
		""" Use this API to fetch all the authenticationwebauthaction resources that are configured on netscaler.
		"""
		try :
			if not name :
	...
	def get_filtered(cls, client, filter_) :
		""" Use this API to fetch filtered set of authenticationwebauthaction resources.
	...
	def count(cls, client) :
		""" Use this API to count the authenticationwebauthaction resources configured on NetScaler.
		"""
		try :
			obj = authenticationwebauthaction()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		""" Use this API to count filtered the set of authenticationwebauthaction resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationwebauthaction()
