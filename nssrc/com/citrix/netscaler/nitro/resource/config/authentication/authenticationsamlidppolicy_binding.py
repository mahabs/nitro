...
class authenticationsamlidppolicy_binding(base_resource):
	...
	def authenticationsamlidppolicy_authenticationvserver_bindings(self) :
		"""authenticationvserver that can be bound to authenticationsamlidppolicy.
		"""
		try :
	...
	def authenticationsamlidppolicy_vpnvserver_bindings(self) :
		"""vpnvserver that can be bound to authenticationsamlidppolicy.
		"""
		try :
	...
	def get(self, service, name) :
		""" Use this API to fetch authenticationsamlidppolicy_binding resource.
		"""
		try :
