...
class authenticationradiuspolicy_authenticationvserver_binding(base_resource) :
	...
	def get(cls, service, name) :
		""" Use this API to fetch authenticationradiuspolicy_authenticationvserver_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, name, filter_) :
		""" Use this API to fetch filtered set of authenticationradiuspolicy_authenticationvserver_binding resources.
	...
	def count(cls, service, name) :
		""" Use this API to count authenticationradiuspolicy_authenticationvserver_binding resources configued on NetScaler.
		"""
		try :
			obj = authenticationradiuspolicy_authenticationvserver_binding()
			obj.name = name
	...
	def count_filtered(cls, service, name, filter_) :
		""" Use this API to count the filtered set of authenticationradiuspolicy_authenticationvserver_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = authenticationradiuspolicy_authenticationvserver_binding()
