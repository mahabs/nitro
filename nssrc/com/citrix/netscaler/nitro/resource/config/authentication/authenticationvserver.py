...
class authenticationvserver(base_resource) :
	...
	@property
	def port(self) :
		"""TCP port on which the virtual server accepts connections.<br/>Minimum length =  1<br/>Range 1 - 65535.
		"""
		try :
			return self._port
		except Exception as e:
	...
	def maxloginattempts(self) :
		"""Maximum Number of login Attempts.<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
