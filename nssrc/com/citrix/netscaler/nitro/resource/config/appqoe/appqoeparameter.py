...
class appqoeparameter(base_resource) :
	...
	def avgwaitingclient(self) :
		"""average number of client connections, that can sit in service waiting queue.<br/>Default value: 1000000<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
	...
	def maxaltrespbandwidth(self) :
		"""maximum bandwidth which will determine whether to send alternate content response.<br/>Default value: 100<br/>Minimum length =  1<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
	...
	def dosattackthresh(self) :
		"""When dosatck is manually decided , this will be used as an upper limit to queue length.<br/>Default value: 2000<br/>Maximum length =  0xFFFFFFFE.
		"""
		try :
