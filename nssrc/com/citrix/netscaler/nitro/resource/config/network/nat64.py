...
class nat64(base_resource) :
	...
	@property
	def acl6name(self) :
		"""Name of any configured ACL6 whose action is ALLOW.  IPv6 Packets matching the condition of this ACL6 rule and destination IP address of these packets matching the NAT64 IPv6 prefix are considered for NAT64 translation.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def netprofile(self) :
		"""Name of the configured netprofile. The NetScaler appliance selects one of the IP address in the netprofile as the source IP address of the translated IPv4 packet to be sent to the IPv4 server.<br/>Minimum length =  1<br/>Maximum length =  127.
		"""
		try :
