...
class route6(base_resource) :
	...
	@property
	def gateway(self) :
		"""The gateway for this route. The value for this parameter is either an IPv6 address or null.<br/>Default value: 0.
		"""
		try :
	...
	@property
	def vlan(self) :
		"""Integer value that uniquely identifies a VLAN through which the NetScaler appliance forwards the packets for this route.<br/>Default value: 0<br/>Maximum length =  4094.
		"""
		try :
			return self._vlan
		except Exception as e:
	...
	@property
	def distance(self) :
		"""Administrative distance of this route from the appliance.<br/>Default value: 1<br/>Minimum length =  1<br/>Maximum length =  254.
		"""
		try :
	...
	@property
	def cost(self) :
		"""Positive integer used by the routing algorithms to determine preference for this route. The lower the cost, the higher the preference.<br/>Default value: 1<br/>Maximum length =  65535.
		"""
		try :
			return self._cost
		except Exception as e:
