...
class vrid_nsip_binding(base_resource) :
	...
	def get(cls, service, id) :
		""" Use this API to fetch vrid_nsip_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, id, filter_) :
		""" Use this API to fetch filtered set of vrid_nsip_binding resources.
	...
	def count(cls, service, id) :
		""" Use this API to count vrid_nsip_binding resources configued on NetScaler.
		"""
		try :
			obj = vrid_nsip_binding()
			obj.id = id
	...
	def count_filtered(cls, service, id, filter_) :
		""" Use this API to count the filtered set of vrid_nsip_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = vrid_nsip_binding()
