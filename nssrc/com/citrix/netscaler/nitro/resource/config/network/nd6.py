...
class nd6(base_resource) :
	...
	@property
	def vlan(self) :
		"""Integer value that uniquely identifies the VLAN on which the adjacent network device exists.<br/>Minimum length =  1<br/>Maximum length =  4094.
		"""
		try :
			return self._vlan
		except Exception as e:
	...
	@property
	def vxlan(self) :
		"""ID of the VXLAN on which the IPv6 address of this ND6 entry is reachable.<br/>Minimum length =  1<br/>Maximum length =  16777215.
		"""
		try :
			return self._vxlan
		except Exception as e:
	...
	@property
	def vtep(self) :
		"""IP address of the VXLAN tunnel endpoint (VTEP) through which the IPv6 address of this ND6 entry is reachable.<br/>Minimum length =  1.
		"""
		try :
			return self._vtep
		except Exception as e:
