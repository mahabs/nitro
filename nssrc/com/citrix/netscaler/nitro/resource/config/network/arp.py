...
class arp(base_resource) :
	...
	@property
	def vxlan(self) :
		"""ID of the VXLAN on which the IP address of this ARP entry is reachable.<br/>Minimum length =  1<br/>Maximum length =  16777215.
		"""
		try :
			return self._vxlan
		except Exception as e:
	...
	@property
	def vtep(self) :
		"""IP address of the VXLAN tunnel endpoint (VTEP) through which the IP address of this ARP entry is reachable.<br/>Minimum length =  1.
		"""
		try :
			return self._vtep
		except Exception as e:
	...
	@property
	def ownernode(self) :
		"""The owner node for the Arp entry.<br/>Maximum length =  31.
		"""
		try :
