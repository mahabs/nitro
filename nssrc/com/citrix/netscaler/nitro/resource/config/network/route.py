...
class route(base_resource) :
	...
	@property
	def cost(self) :
		"""Positive integer used by the routing algorithms to determine preference for using this route. The lower the cost, the higher the preference.<br/>Maximum length =  65535.
		"""
		try :
			return self._cost
		except Exception as e:
	...
	@property
	def distance(self) :
		"""Administrative distance of this route, which determines the preference of this route over other routes, with same destination, from different routing protocols. A lower value is preferred.<br/>Default value: 1<br/>Maximum length =  255.
		"""
		try :
	...
	@property
	def cost1(self) :
		"""The cost of a route is used to compare routes of the same type. The route having the lowest cost is the most preferred route. Possible values: 0 through 65535. Default: 0.<br/>Maximum length =  65535.
		"""
		try :
			return self._cost1
		except Exception as e:
	...
	@property
	def weight(self) :
		"""Positive integer used by the routing algorithms to determine preference for this route over others of equal cost. The lower the weight, the higher the preference.<br/>Default value: 1<br/>Minimum length =  1<br/>Maximum length =  65535.
		"""
		try :
			return self._weight
		except Exception as e:
	...
	@property
	def routetype(self) :
		"""Protocol used by routes that you want to remove from the routing table of the NetScaler appliance.<br/>Possible values = CONNECTED, STATIC, DYNAMIC, OSPF, ISIS, RIP, BGP, VPATH.
		"""
		try :
