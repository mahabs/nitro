...
class vlan(base_resource) :
	...
	@property
	def id(self) :
		"""A positive integer that uniquely identifies a VLAN.<br/>Minimum length =  1<br/>Maximum length =  4094.
		"""
		try :
			return self._id
	...
	@property
	def mtu(self) :
		"""Specifies the maximum transmission unit (MTU), in bytes. The MTU is the largest packet size, excluding 14 bytes of ethernet header and 4 bytes of crc, that can be transmitted and received over this VLAN.<br/>Default value: 0<br/>Minimum length =  500<br/>Maximum length =  9216.
		"""
		try :
			return self._mtu
		except Exception as e:
	...
	@property
	def vlantd(self) :
		"""Traffic domain associated with vlan.<br/>Minimum value =  0<br/>Maximum value =  4094.
		"""
		try :
			return self._vlantd
		except Exception as e:
