...
class rnat(base_resource) :
	...
	@property
	def netmask(self) :
		"""The subnet mask for the network address.<br/>Minimum length =  1.
		"""
		try :
	...
	def srcippersistency(self) :
		"""Enables the NetScaler appliance to use the same NAT IP address for all RNAT sessions initiated from a particular server.<br/>Default value: DISABLED<br/>Possible values = ENABLED, DISABLED.
		"""
		try :
