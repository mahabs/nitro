...
class inatparam(base_resource) :
	...
	@property
	def nat46v6mtu(self) :
		"""MTU setting for the IPv6 side. If the incoming IPv4 packet greater than this, either fragment or send icmp need fragmentation error.<br/>Default value: 1280<br/>Minimum length =  1280<br/>Maximum length =  9216.
		"""
		try :
	...
	def get_filtered(cls, client, filter_) :
		""" Use this API to fetch filtered set of inatparam resources.
	...
	def count(cls, client) :
		""" Use this API to count the inatparam resources configured on NetScaler.
		"""
		try :
			obj = inatparam()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		""" Use this API to count filtered the set of inatparam resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = inatparam()
