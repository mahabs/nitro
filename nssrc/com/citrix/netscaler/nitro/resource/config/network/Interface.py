...
class Interface(base_resource) :
	...
	@property
	def lagtype(self) :
		"""Type of entity (NetScaler appliance or cluster configuration) for which to create the channel.<br/>Default value: NODE<br/>Possible values = NODE, CLUSTER.
		"""
		try :
	...
	@property
	def throughput(self) :
		"""Low threshold value for the throughput of the interface, in Mbps. In an HA configuration, failover is triggered if the interface has HA MON enabled and the throughput is below the specified the threshold.<br/>Maximum length =  160000.
		"""
		try :
	...
	def bandwidthhigh(self) :
		"""High threshold value for the bandwidth usage of the interface, in Mbps. The NetScaler appliance generates an SNMP trap message when the bandwidth usage of the interface is greater than or equal to the specified high threshold value.<br/>Maximum length =  160000.
		"""
		try :
