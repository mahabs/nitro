...
class vrid(base_resource) :
	...
	@property
	def priority(self) :
		"""Base priority (BP), in an active-active mode configuration, which ordinarily determines the master VIP address.<br/>Default value: 255<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
	...
	@property
	def ownernode(self) :
		"""Assign a cluster node as the owner of this VMAC address. If no owner is configured, owner node is displayed as ALL and one node is dynamically elected as the owner.<br/>Maximum length =  31.
		"""
		try :
	...
	def operationalownernode(self) :
		"""Run time owner node of the vrid.<br/>Minimum value =  0<br/>Maximum value =  31.
		"""
		try :
