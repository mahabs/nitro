...
class rnatglobal_auditsyslogpolicy_binding(base_resource) :
	...
	@classmethod
	def get(cls, service) :
		""" Use this API to fetch a rnatglobal_auditsyslogpolicy_binding resources.
		"""
		try :
	...
	def get_filtered(cls, service, filter_) :
		""" Use this API to fetch filtered set of rnatglobal_auditsyslogpolicy_binding resources.
	...
	def count(cls, service) :
		""" Use this API to count rnatglobal_auditsyslogpolicy_binding resources configued on NetScaler.
		"""
		try :
			obj = rnatglobal_auditsyslogpolicy_binding()
			option_ = options()
	...
	def count_filtered(cls, service, filter_) :
		""" Use this API to count the filtered set of rnatglobal_auditsyslogpolicy_binding resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = rnatglobal_auditsyslogpolicy_binding()
