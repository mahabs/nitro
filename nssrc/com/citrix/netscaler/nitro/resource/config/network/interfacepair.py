...
class interfacepair(base_resource) :
	...
	@property
	def id(self) :
		"""The Interface pair id.<br/>Minimum length =  1<br/>Maximum length =  255.
		"""
		try :
			return self._id
	...
	@property
	def ifnum(self) :
		"""The constituent interfaces in the interface pair.<br/>Minimum length =  1.
		"""
		try :
			return self._ifnum
		except Exception as e:
	...
	def add(cls, client, resource) :
		""" Use this API to add interfacepair.
		"""
		try :
	...
	def delete(cls, client, resource) :
		""" Use this API to delete interfacepair.
		"""
		try :
			if type(resource) is not list :
	...
	def get(cls, client, name="", option_="") :
		""" Use this API to fetch all the interfacepair resources that are configured on netscaler.
		"""
		try :
			if not name :
				obj = interfacepair()
	...
	def get_filtered(cls, client, filter_) :
		""" Use this API to fetch filtered set of interfacepair resources.
	...
	def count(cls, client) :
		""" Use this API to count the interfacepair resources configured on NetScaler.
		"""
		try :
			obj = interfacepair()
			option_ = options()
	...
	def count_filtered(cls, client, filter_) :
		""" Use this API to count filtered the set of interfacepair resources.
		Filter string should be in JSON format.eg: "port:80,servicetype:HTTP".
		"""
		try :
			obj = interfacepair()
