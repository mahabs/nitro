...
class forwardingsession(base_resource) :
	...
	@property
	def network(self) :
		"""An IPv4 network address or IPv6 prefix of a network from which the forwarded traffic originates or to which it is destined.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def acl6name(self) :
		"""Name of any configured ACL6 whose action is ALLOW. The rule of the ACL6 is used as a forwarding session rule.<br/>Minimum length =  1.
		"""
		try :
	...
	@property
	def aclname(self) :
		"""Name of any configured ACL whose action is ALLOW. The rule of the ACL is used as a forwarding session rule.<br/>Minimum length =  1.
		"""
		try :
