...
class cmppolicylabel_stats(base_resource) :
	...
	@property
	def labelname(self) :
		"""Name of the compression policy label for which to display statistics. If not specified, statistics are displayed for all compression policy labels.<br/>Minimum length =  1.
		"""
		try :
