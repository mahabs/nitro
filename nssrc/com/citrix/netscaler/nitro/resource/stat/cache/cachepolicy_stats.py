...
class cachepolicy_stats(base_resource) :
	...
	@property
	def policyname(self) :
		"""Name of the cache policy for which to display statistics. If you do not set this parameter, statistics are shown for all cache policies.<br/>Minimum length =  1.
		"""
		try :
