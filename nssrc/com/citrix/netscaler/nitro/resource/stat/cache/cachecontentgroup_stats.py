...
class cachecontentgroup_stats(base_resource) :
	...
	@property
	def name(self) :
		"""Name of the cache contentgroup for which to display statistics. If you do not set this parameter, statistics are shown for all cache contentgroups.<br/>Minimum length =  1.
		"""
		try :
			return self._name
	...
	def  get(cls, service, name="", option_="") :
		""" Use this API to fetch the statistics of all cachecontentgroup_stats resources that are configured on netscaler.
		"""
		try :
